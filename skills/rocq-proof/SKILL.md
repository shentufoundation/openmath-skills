...
docs:
  - docs/core-theory.md   # CIC, sorts, definitional equality, inductive definitions, Corelib contents
  - docs/gallina.md       # Gallina language: sorts, definitions, inductives, pattern matching, recursive functions
  - docs/tactics.md       # Full tactic reference: goal management, apply/rewrite, induction, automation
  - docs/ltac.md          # Ltac control flow, Ltac2 types/backtracking/quotations, SSReflect bookkeeping
  - docs/references.md    # Proof mode commands, goal focusing, context management, automation tactics
  - docs/stdlib.md        # Stdlib modules: numbers, data structures, solvers (lia, ring, Psatz, omega)
  - docs/mathcomp.md      # MathComp library overview, SSReflect style, package structure, learning resources
---
